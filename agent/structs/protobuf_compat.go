...
// and the proto/common.QueryOptions structs need to implement so that they
...
// and the proto/common.QueryMeta structs need to implement so that they
// can be operated on interchangeably
...
// Copied from proto/common/common.pb.go
...
// Copied from proto/common/common.go
