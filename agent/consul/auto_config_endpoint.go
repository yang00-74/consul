...
import (
	...
	pbconnect "github.com/hashicorp/consul/proto/connect"
...
func (ac *AutoConfig) updateTLSCertificatesInConfig(opts AutoConfigOptions, resp *autoconf.AutoConfigResponse) error {
...
func (ac *AutoConfig) updateACLsInConfig(opts AutoConfigOptions, resp *autoconf.AutoConfigResponse) error {
	acl := &config.ACL{
...
func (ac *AutoConfig) updateJoinAddressesInConfig(opts AutoConfigOptions, resp *autoconf.AutoConfigResponse) error {
...
func (ac *AutoConfig) updateGossipEncryptionInConfig(_ AutoConfigOptions, resp *autoconf.AutoConfigResponse) error {
...
func (ac *AutoConfig) updateTLSSettingsInConfig(_ AutoConfigOptions, resp *autoconf.AutoConfigResponse) error {
	if ac.tlsConfigurator == nil {
		// TLS is not enabled?
		return nil
	}
...
func (ac *AutoConfig) baseConfig(opts AutoConfigOptions, resp *autoconf.AutoConfigResponse) error {
	if opts.NodeName == "" {
...
type autoConfigUpdater func(c *AutoConfig, opts AutoConfigOptions, resp *autoconf.AutoConfigResponse) error
