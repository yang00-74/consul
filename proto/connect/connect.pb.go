...
import (
	...
	common "github.com/hashicorp/consul/proto/common"
	io "io"
	math "math"
)
...
func (*CARoots) Descriptor() ([]byte, []int) {
	return fileDescriptor_78181baa9a3da00d, []int{0}
}
...
func (*CARoot) Descriptor() ([]byte, []int) {
	return fileDescriptor_78181baa9a3da00d, []int{1}
}
...
func (*IssuedCert) Descriptor() ([]byte, []int) {
	return fileDescriptor_78181baa9a3da00d, []int{2}
}
...
func init() { proto.RegisterFile("proto/connect/connect.proto", fileDescriptor_78181baa9a3da00d) }

var fileDescriptor_78181baa9a3da00d = []byte{
	// 664 bytes of a gzipped FileDescriptorProto
	,
}
